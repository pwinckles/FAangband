...
extern bool square_reveal_trap(struct cave *c, int y, int x, int chance, bool msg);
extern void hide_trap_idx(int idx);
extern int num_traps(struct cave *c, int y, int x, int vis);
...
bool square_remove_trap(struct cave *c, int y, int x, bool msg, int t_idx);
void square_remove_trap_kind(struct cave *c, int y, int x, bool msg, int t_idx);
